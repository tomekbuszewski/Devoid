...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomePage = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SmallPost = __webpack_require__(218);
	  ...
	  _createClass(HomePage, [{
	    ...
	    value: function fetchPosts() {
	      ...
	      req.onreadystatechange = function () {
	        if (req.readyState === 4) {
	          if (req.status === 200) {
	            _this2.tempData = req.responseText;
	            _this2.renderPosts();
	          } else {
	            throw new Error();
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SmallPost = function (_React$Component) {
	  _inherits(SmallPost, _React$Component);

	  function SmallPost(props) {
	    _classCallCheck(this, SmallPost);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SmallPost).call(this, props));
	  }
	  ...
	  _createClass(Post, [{
	    ...
	    value: function fetchPost() {
	      ...
	      req.onreadystatechange = function () {
	        if (req.readyState === 4) {
	          if (req.status === 200) {
	            _this2.postData = req.responseText;
	            _this2.renderPost();
	          } else {
	            throw new Error();
	          }
